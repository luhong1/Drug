...
<div style="width: 20%;float: right;margin-bottom:15px">
<a class="btn btn-primary" href="medecineServlet?payType=${payType}&drugType=${drugType }&caseNum=${caseNum }&time=${time }"  >退药</a>
			</div>
			</div>
	    ...
	    <table class="table table-bordered" style="width: 50%;margin-bottom:0px;margin-left: 150px">
		<thead>
			<tr>
